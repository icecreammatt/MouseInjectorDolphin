...
#define MOHEA_camx 0x80A7E610 - 0x80A7E530
#define MOHEA_camy 0x80A7E608 - 0x80A7E530
#define MOHEA_fov 0x80A7E638 - 0x80A7E530
// STATIC ADDRESSES BELOW
#define MOHEA_playerbase 0x815A3780
...
static uint8_t MOHEA_Status(void)
{
	if(MEM_ReadInt(0x80000000) == 0x474F4E45 && MEM_ReadInt(0x80000004) == 0x36390000) // check game header to see if it matches MOHEA
		return 1;
	return 0;
}
//==========================================================================
